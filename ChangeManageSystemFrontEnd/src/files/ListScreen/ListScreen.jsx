...
import user from "../Functions/UserFile";
...
const ListScreenApp = () => {
  ...
  let operationUserCheck = false;

  if (getCookie("authorizationLevel") == "operationUser") {
    operationUserCheck = true;
  }
  ...
  const fetchRequest = () => {
    if (orderByStateLevel) {
      ...
      fetch(`http://localhost:8080/changerequests?` + searchParams.toString(), {
        method: "GET",
      })
        .then((res) => res.json())
        .then((res) => {
  ...
  const setOrder = (e) => {
    if (operationUserCheck) {
      switch (e) {
        case 1:
          break;
        case 2:
          //document.getElementById("u519_text").setAttribute("style", {cursor: 'pointer'});
          //console.log(document.getElementById("u519_text").setAttribute("class", "test"));
          break;
        case 3:
          break;
        case 4:
      ...
      document
        .getElementById("u519_text")
        .setAttribute("style", "cursor: pointer");

      document
        .getElementById("u510_text")
        .setAttribute("style", "cursor: pointer");

      document
        .getElementById("u542_text")
        .setAttribute("style", "cursor: pointer");

      document
        .getElementById("u544_text")
        .setAttribute("style", "cursor: pointer");
    }
  };
  ...
  const handleClick = (e) => {
    ...
    if (e === "state") {
      ...
      if (
        document.getElementById("u507_div").getAttribute("class") == "" &&
        e == "1"
      ) {
        // Tab 1
        ...
        document
          .getElementById("u508_state0")
          .setAttribute("style", "visibility: visible");
        document
          .getElementById("u507_div")
          .setAttribute("style", "background-color: rgba(0, 135, 71, 1)");
        document
          .getElementById("u506_div")
          .setAttribute("style", "background-color: rgba(215, 215, 215, 1);");

        document
          .getElementById("u508_state1")
          .setAttribute("style", "visibility: hidden");
      } else if (
        document.getElementById("u506_div").getAttribute("class") == "" &&
        e == "2"
      ) {
        // Tab 2
  ...
  return (
    <div id="base" class="">
      ...
      <div
        id="u501"
        class="ax_default label ax_default_hidden"
        data-label="Updated Employee Value"
        style={{ display: "none", visibility: "hidden" }}
      >
      ...
      >
        ...
        >
          ...
          <div
            id="u507"
            class="ax_default box_3 selected"
            data-label="Tab Label 1"
            selectiongroup="Tabs"
          ...
          >
            <div
              id="u507_div"
              class="selected"
              style={{ "background-color": "rgba(0, 135, 71, 1)" }}
            ></div>
          ...
          <div id="u508_state0" class="panel_state" data-label="State1">
            <div id="u508_state0_content" class="panel_state_content">
              <div
                ...
                data-label="Change Number (Header)"
              >
                <div id="u510_div" class=""></div>
                <div
                  id="u510_text"
                  class="text "
                  onClick={() => handleClick("changeId")}
                >
                  <p>
              ...
              <div
                id="u512"
                class="ax_default box_1"
                data-label="Application ID (Header)"
              >
              ...
              <div
                id="u515"
                class="ax_default box_1"
                data-label="Reason Number (Header)"
              >
              ...
              <div
                id="u520"
                class="ax_default"
                data-label="Table Repeater"
                style={{ "overflow-x": "hidden", height: "370px" }}
              >
                {(index = 1)}
          ...
          >
            <div id="u508_state1_content" class="panel_state_content">
              <div
                id="u534"
                class="ax_default box_1"
                data-label="Window Start Date (Header)"
              >
              ...
              <div
                id="u535"
                class="ax_default box_1"
                data-label="Window Start Time (Header)"
              >
              ...
              <div
                id="u536"
                class="ax_default box_1"
                data-label="Window Stop Date (Header)"
              >
                <div id="u536_div" class=""></div>
                <div id="u536_text" class="text ">
                  <p>
                    <span>Window Stop Date</span>
                  </p>
                </div>
              </div>
              ...
              <div
                id="u537"
                class="ax_default box_1"
                data-label="Window Stop Time (Header)"
              >
                <div id="u537_div" class=""></div>
                <div id="u537_text" class="text ">
                  <p>
                    <span>Window Stop Time</span>
                  </p>
                </div>
              </div>
              ...
              <div
                id="u538"
                class="ax_default box_1"
                data-label="Backout Plan (Header)"
              >
              ...
              <div
                id="u539"
                class="ax_default box_1"
                data-label="Backout Minutes (Header)"
              >
                <div id="u539_div" class=""></div>
                <div id="u539_text" class="text ">
                  <p>
                    <span>Backout Minutes</span>
                  </p>
                </div>
              </div>
              ...
              <div
                id="u540"
                class="ax_default box_1"
                data-label="Other Needed Departments"
              >
                <div id="u540_div" class=""></div>
                <div id="u540_text" class="text ">
                  <p>
                    <span>Other Needed Departments</span>
                  </p>
                </div>
              </div>
