      ...
      if(props.tabSet == 1) {
        return (
          ...
          <div id="u520-1" class="preeval" style={{width: '1317px', height: '70px', top: ((indexNumber - 1) * 80) + "px"}}>
                        ...
                        <div id="u531-1" class="ax_default box_1 u531" data-label="Action" style={{width: '135px', height: '70px', left: '1163px', top: '0px', visibility: 'inherit'}}>
                          <div id="u531-1_div" class="u531_div" style={{width: '135px', height: '70px', visibility: 'inherit'}}></div>
        ...
        <div id="u545-1" class="preeval" style={{width: '1312px', height: '30px', top: ((indexNumber - 1) * 80) + "px"}}>
          ...
          <div id="u556-1" class="ax_default box_1 u556" data-label="Action" style={{width: '280px', height: '70px', left: '1018px', top: '0px', visibility: 'inherit'}}>
            <div id="u556-1_div" class="u556_div" style={{width: '280px', height: '70px', visibility: 'inherit'}}></div>
